...
Timer *timer;                 ///< The hardware timer device, for invoking
                              ///< context switches.
SynchConsole *consola;        ///< Consola global
...
Bitmap *paginas;  /// Bitmap donde marcaremos las paginas fisicas utilizadas.
Table<Thread*> *corriendo;
#endif
...
Initialize(int argc, char **argv)
{
    ...
    paginas = new Bitmap(NUM_PHYS_PAGES);
